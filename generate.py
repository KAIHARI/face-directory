...
(function() {
  ...
  const POSITIONS = [
    ...
    // Healthcare & Medical
    'Physician','Doctor','Surgeon','Anesthesiologist','Cardiologist',
    ...
    'Charge Nurse','Travel Nurse','Nurse Anesthetist','Nurse Midwife',
    'Physician Assistant','PA','Medical Assistant','Clinical Assistant',
    'Pharmacist','Pharmacy Technician','Pharmacy Manager',
    'Physical Therapist','Occupational Therapist','Speech Therapist',
    'Respiratory Therapist','Recreational Therapist',
    'Dentist','Dental Hygienist','Dental Assistant','Orthodontist',
    'Optometrist','Optician','Audiologist',
    ...
    'Lab Technician','Laboratory Director','Pathologist',
    'Radiologic Technologist','Ultrasound Technician','MRI Technician',
